  ...
  return (
    <div className="min-h-screen">
      <div className="container mx-auto px-4 py-16 max-w-6xl">
        ...
        {/* Content Grid - 2 stacked on left, 1 tall on right */}
        <div className="grid md:grid-cols-2 gap-8">
          ...
          {/* Right Column - 1 tall box */}
          <div className="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all animate-fade-in flex flex-col">
